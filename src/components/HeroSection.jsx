      ...
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
           {isChange ? "Knausgaard typewriter readymade marf" : "This is changed"}         </h1>
          ...
          <div className="flex w-full md:justify-start justify-center items-end">
            ...
            <button onClick={toggleElements} className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">
              CLICK ME
            </button>
          </div>
        ...
        <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
          <img
            ...
            src={Images.image1}
          />
          {/* <button onClick={toggleElements} className="bg-red-600 p-2">Change Text</button> */}
        </div>
      </div>
    </section>
  );
